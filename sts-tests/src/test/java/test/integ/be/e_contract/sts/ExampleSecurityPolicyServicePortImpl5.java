...
@WebService(endpointInterface = "be.e_contract.sts.example.ExampleServicePortType", targetNamespace = "urn:be:e-contract:sts:example", serviceName = "ExampleService", wsdlLocation = "example-security-policy.wsdl", portName = "ExampleServicePort5")
...
public class ExampleSecurityPolicyServicePortImpl5 implements
		ExampleServicePortType {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ExampleSecurityPolicyServicePortImpl5.class);
